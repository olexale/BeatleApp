...
namespace BeatlesApp
{
    public class BeatleModel
    {
        ...
        public BeatleModel(int id, string name, ImageSource image, string bio)
        {
            Id = id;
            Name = name;
            Image = image;
